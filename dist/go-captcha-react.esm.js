...
var styles = {"wrapper":"gocaptcha-module_wrapper__Kpdey","theme":"gocaptcha-module_theme__h-Ytl","header":"gocaptcha-module_header__LjDUC","body":"gocaptcha-module_body__KJKNu","picture":"gocaptcha-module_picture__LRwbY","hide":"gocaptcha-module_hide__TUOZE","loading":"gocaptcha-module_loading__Y-PYK","footer":"gocaptcha-module_footer__Ywdpy","iconBlock":"gocaptcha-module_iconBlock__mVB8B","buttonBlock":"gocaptcha-module_buttonBlock__EZ4vg","dragSlideBar":"gocaptcha-module_dragSlideBar__noauW","dragLine":"gocaptcha-module_dragLine__3B9KR","dragBlock":"gocaptcha-module_dragBlock__bFlwx","dragBlockInline":"gocaptcha-module_dragBlockInline__PpF3f"};
...
const Index = props => {
  ...
  return React__default.createElement("div", {
  ...
  }, React__default.createElement("span", null, conf.title), React__default.createElement("img", {
    className: data.thumb == '' ? styles.hide : '',
    style: {
    ...
    className: classnames(styles.picture, data.image == '' ? styles.hide : ''),
    style: {
      width: conf.width + "px",
      height: conf.height + "px"
    },
...
const Index$1 = props => {
  ...
  const width = (conf.width || 0) + hPadding * 2 + (conf.showTheme ? 2 : 0);
  useEffect(() => {
    dragBlockRef.current.addEventListener('dragstart', event => event.preventDefault());
  }, [dragBlockRef]);
  return React__default.createElement("div", {
    className: classnames(styles.wrapper, conf.showTheme ? styles.theme : ''),
    style: {
    ...
    className: styles.header
  }, React__default.createElement("span", null, conf.title), React__default.createElement("div", {
...
const Index$3 = props => {
  ...
  return React__default.createElement("div", {
    ...
    className: data.image == '' ? styles.hide : '',
    src: data.image,
    alt: "..."
  }), React__default.createElement("div", {
